...
// required).
//
// The modal is intentionally tiny — the user already decided they
// don't like the answer, we just want a fine-tune-actionable reason.
// No correction field in v1 (YAGNI — see docs/.../ask-feedback.md §9).
//
