...
// successfully returned. The "now" endpoint in the comparison
// preview and the detail panel pin to this value so the window
// doesn't slide while the operator is reading the result.
